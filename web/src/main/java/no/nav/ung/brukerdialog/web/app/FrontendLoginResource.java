...
public class FrontendLoginResource {
    ...
    @GET
    public Response login(@QueryParam("redirectTo") @DefaultValue("/ung/web/") String redirectTo, @QueryParam("original") @DefaultValue("/ung/brukerdialog") String originalUri, @Context HttpServletRequest httpServletRequest) {
