package no.nav.ung.brukerdialog.web.app.selftest;
...
import no.nav.ung.brukerdialog.web.app.tjenester.ApplicationServiceStarter;
import no.nav.ung.brukerdialog.web.server.jetty.JettyServer;
