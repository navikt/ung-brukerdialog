...
This directory contains the generated **ung-brukerdialog.openapi.json** specification file and other files used as input to define
a generated openapi typescript client.

The ung-brukerdialog.openapi.json file is generated from the java source in this project, and represents a specification of the 
...
The ung-brukerdialog.openapi.json file is automatically generated during the build pipeline. Changes to the generated result is 
...
[@navikt/ung-brukerdialog-typescript-client](https://github.com/navikt/ung-brukerdialog/pkgs/npm/ung-brukerdialog-typescript-client)**.
...
### Code example
```typescript
import { UngSakClient } from "@navikt/ung-brukerdialog-typescript-client";
