...
(
    ...
    TASK_PAYLOAD                    TEXT,
    TASK_GRUPPE                     VARCHAR(250)                                    NOT NULL ,
    ...
    ENDELIG_FEILET_FOERSTE_GANG_TID TIMESTAMP(6)
...
COMMENT
ON COLUMN PROSESS_TASK.SISTE_KJOERING_TS IS 'siste gang tasken ble forsøkt kjørt';
COMMENT
...
CREATE INDEX IDX_PROSESS_TASK_8
    ON PROSESS_TASK_PARTITION_DEFAULT (TASK_GRUPPE, LENGTH(TASK_SEKVENS), TASK_SEKVENS)
