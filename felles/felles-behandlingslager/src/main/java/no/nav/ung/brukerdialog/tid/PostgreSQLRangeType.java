...
*/
package no.nav.ung.brukerdialog.tid;
 ...
 */
public class PostgreSQLRangeType extends UserTypeSupport<Range<?>> {
    ...
    @Override
    public Range<?> nullSafeGet(ResultSet rs, int position, SharedSessionContractImplementor session, Object owner) throws SQLException {
    ...
    @Override
    public void nullSafeSet(PreparedStatement st, Range<?> range, int index, SharedSessionContractImplementor session) throws SQLException {
        if (range == null) {
